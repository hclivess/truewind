...
for (const cls of Object.keys(CLASSES)) for (const twa of [45, 90]) {
  ...
  console.log(`${cls.padEnd(10)} TWA ${twa}  bsp ${(b.u / KT).toFixed(1)}  heel ${(b.phi / DEG).toFixed(0)}°  N sail ${d.Nsail.toFixed(0)}  keel ${d.Nkeel.toFixed(0)}  hull ${d.Nhull.toFixed(0)}  net ${Nn.toFixed(0)} ${Nn < 0 ? '(weather helm)' : '(LEE helm)'}`);
}
